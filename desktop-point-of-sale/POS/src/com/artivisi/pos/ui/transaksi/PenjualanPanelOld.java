 ...
 * @author ifnu
 */
public class PenjualanPanelOld extends javax.swing.JInternalFrame {
    ...
    private void initListeners(){
        ...
        transaksiToolbarPanel1.getBtnKeluar().addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                FrameUtama.getInstance().removeInternalFrame(PenjualanPanelOld.this);
            }
        });
